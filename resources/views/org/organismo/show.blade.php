@extends('org.layout.app')

@section('title', 'Dashboard')

@section('header')
    @include('org.layout.header')
@endsection

@section('lateral')
    @include('org.layout.lateral')
@endsection
    ...
    <div class="container-xl px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
            <div class="me-4 mb-3 mb-sm-0">
                <h1 class="mb-0">{{ $organismo->razaosocial}}</h1>
                <div class="small">
                    ...
                    <div class="card-body d-flex justify-content-center flex-column">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="me-3">
                                ...
                                <div class="text-muted small">Cadastro financeiro, Movimentações no Caixa da Fraternidade</div>
                            </div>
                            <img src="/assets/img/illustrations/Piggy bank-pana.svg" alt="..." style="width: 8rem" />
                        </div>
                    </div>
                </a>
            </div>
